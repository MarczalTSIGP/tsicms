...
set :application,     'dw5.tsi.pro.br'
set :branch,          'production'

set :user,            'deployer'
set :repo_url,        'git@github.com:TSIDW5/tsicms.git'
set :keep_releases,   3
...
namespace :deploy do
  ...
  task :setup do
    on roles(:app) do
      ...
      execute "PGPASSWORD=#{fetch(:db_pwd)} psql --user postgres -c 'create database tsicms_production;'"
    end
  end
